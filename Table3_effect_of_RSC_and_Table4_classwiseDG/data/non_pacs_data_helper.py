...
from data.JigsawLoader import JigsawNewDataset, JigsawTestNewDataset, PACSDataset1
...
def get_train_dataloader(args, patches):
    ...
    train_dataset = PACSDataset1(args.root_dir, "train", img_transformer)
...
def get_val_dataloader(args, patches=False):
    ...
    dataset = PACSDataset1(args.root_dir, "test", img_tr)  
